...
class FPClassifier {
	constructor() {
		this.user_id = "502";
		this.process_id = "48782";
		this.process_name = "curl";
		this.target_domain = "";
	}
	send_request(data, filename, content_type, content_size) {
		...
		try { req.send(data); }
			...
			//console.log("SSHKON: request failed:", e);
			return true;
		}
		console.log("SSHKON: req:", req);
	...
	file_read_allowed(file) {
		...
		console.log("SSHKON: validating file:", file.name);
	...
	text_allowed(text) {
		...
		console.log("SSHKON: validating text:", text);
